...
public class BMI extends Applet implements ActionListener{
	...
	public void actionPerformed(ActionEvent  ae){
		...
		if(bmi < 18.5) {
				t3.setText("You are underweight");
			}else if (bmi < 25) {
				t3.setText("You are normal");
			}else if (bmi < 30) {
				t3.setText("You are overweight");
			}else {
				t3.setText("You are obese");
			}
		}
	}
}
